...
3. The five frames live on the phone and are rewatched at the window after
   ...
   the monitor plainly: dark without power, three live feeds with it, the
   northern one black either way. Nothing fires there.
4. Act I gates. Power is optional and has consequences but no health cost.
   Sleeping without a fire is allowed, costs health and changes the waking.
...
| `sauna` | Sauna | Separate building down towards the lake. Wood-fired, no electricity, the lake in the small window. | out to the grounds |
...
Objects in the story are not inventory. The phone, the key, the head torch,
the compass and the meter are in her pockets or her pack from the road end
and are never listed, taken or dropped. Inventory holds what the fiction
...
| Phone | Pocket. One bar at the main-room window angled at the road, none anywhere else. Carries the voicemail and the five frames. | Pocket. The live feed at the errand. | In her jacket on the peg. Will not wake: dark all through. | The call at the window, four rings. |
...
| Water, bedding | Two buckets from the pump before the light goes; bedding from the chest hung near the hearth. Part of the reopening beat. | | | |
...
| Monitor (konttori) | Dark without power. With it, three feeds holding frost and stillness, the northern one black. No beat. | As left. | Absent. | As left. |
...
| Sauna stove | Cold. Fed for half an hour if she goes; stones give back heat that evening only. | Cold again. | "Sauna will have to wait." If she never went, the line changes: there was no sauna to wait for. | Not walkable. |
...
| Towel | Carried down to the sauna. | | Warming on the rail by the stove. | |
...
does not. Each fact has one place it is told and must not be referred to
before it.
...
| Nika's voicemail, word for word, and the pause. | Eleven days. | At the window, after the fire, before the frames. | Any earlier line may say a message waits; none may quote it. |
...
| The dinner, the wine, the plan for the morning. | | The bed beat. | |
...
| The Cabin | Cold and dark on entry (cutscene). Then by state: hearth cold or lit, bulb dark or weak yellow, bedding by the hearth once the ritual is done, the white mug on the table after it, the corked bottle after dinner. Item lines follow: the hearth is bare or burning, the matches are on the shelf or in her hand. | Morning light in the window, the fire banked or the hearth dead, the bottle on the counter. Coffee at the window looking north. | The false cabin, by stage, as implemented. The lamp, not the bulb. The stopped room after the refusal. | Cold, dark, yesterday's fire or none; the bed open through the bedroom door; the bottle and glass; the hook. Then the scraping, then the chair. Leaving refused. |
| Konttori | Desk, manuals, router. Monitor dark, or three grey feeds with the northern one black. No beat. | As left. | Absent. | As left; not worth a visit and not refused. |
...
| Sauna | Low and dark; the lake a dark plate in the window at dusk. Stones cold, then giving back heat. | Cold again, daylight in the window. | Absent. | Not walkable. |
...
- Small inventions that are not in the prose are cut, not defended: no
  Rovaniemi, no Toyota, no "Home".
