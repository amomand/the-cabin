    ...
    if stage == "seated":
        ...
        return ActionResult.authored(
            feedback=(
                ...
                "o'clock of the handle. Your thumb goes to it on its own, "
                "as it has through every summer of your childhood. "
                "The coffee is pale with milk, no sugar, the way you take it. The "
                "first mouthful tastes of being twelve years old with lake water "
                "in your hair.\n\n"
                "Your eyes sting. You keep them down until it passes. The hook by "
                "the stove was empty last night, but Nika must have found the mug "
                "somewhere. The coffee is warm and made for you without asking. "
    ...
    if stage == "arrival":
        ...
        return ActionResult.authored(
            feedback=(
                ...
                "looking before I lose the light. Then you come through the door like "
                "a shot elk.\"\n"
