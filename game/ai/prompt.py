...
SYSTEM_PROMPT_TEMPLATE = (
    ...
    "- Story fixtures like phone, camera feed, key, compass, head torch, meter, northern camera, sauna stove, bed, mattress, tins, Nika, mug, and window must use action 'use'.\n"
